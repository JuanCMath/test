...
// Implementar las funciones de tabs de GTK
...
void setup_port_scanner_tab(MatComGuardApp *app_data) {
    // Add tab to notebook
    gtk_notebook_append_page(GTK_NOTEBOOK(app_data->notebook), gtk_label_new("Port Scanner"),
                            gtk_label_new("🏰 Defensores de Murallas"));
}

void setup_alerts_tab(MatComGuardApp *app_data) {
    // Add tab to notebook
    gtk_notebook_append_page(GTK_NOTEBOOK(app_data->notebook), gtk_label_new("Alerts"),
...
void setup_process_monitor_tab(MatComGuardApp *app_data) { /* implementar */ }
void setup_port_scanner_tab(MatComGuardApp *app_data) { /* implementar */ }
void setup_alerts_tab(MatComGuardApp *app_data) { /* implementar */ }
void on_process_scan_clicked(GtkButton *button, gpointer user_data) { /* implementar */ }
void on_port_scan_clicked(GtkButton *button, gpointer user_data) { /* implementar */ }
void on_alerts_clear_clicked(GtkButton *button, gpointer user_data) { /* implementar */ }
void on_scan_all_clicked(GtkButton *button, gpointer user_data) { /* implementar */ }
void on_export_report_clicked(GtkButton *button, gpointer user_data) { /* implementar */ }
void update_process_display(MatComGuardApp *app_data) { /* implementar */ }
void update_port_display(MatComGuardApp *app_data) { /* implementar */ }
void update_alerts_display(MatComGuardApp *app_data) { /* implementar */ }
gpointer process_scan_thread(gpointer user_data) { return NULL; }
gpointer port_scan_thread(gpointer user_data) { return NULL; }
gpointer full_scan_thread(gpointer user_data) { return NULL; }
gboolean periodic_scan_callback(gpointer user_data) { return TRUE; }
